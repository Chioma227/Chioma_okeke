...
const Footer = () => {
    ...
    return (
        <footer className='w-full footer'>
            ...
            <section className='flex items-center justify-between border border-t-2 border-opacity-5 border-yellow-50 py-[20px] px-[10px] text-wheat-bold'>
                <small className='text-[10px]'>&copy; 2024. Made By Chioma Okeke.</small>
                <p className='text-[10px]'>{timeOfDay}</p>
            </section>
        </footer>
    )
}
